...
//  YaAPI
//
//  Created by Devel on 07.08.2022.
//

import Foundation
import Shared

public enum MoveError: Int, Error {
    case invalidDiskResponce = 400, cantAuthWithToken  = 401, wrongPathTo               = 403,
         ...
         notEnoughFreeSpace  = 507, noConnectionToDisk  = 0,  resourceAlreadyExists     = 409
}

extension MoveError: LocalizedErrorStructProtocol {
    public var errorToLogoff:      Int  { 401 }
    public var successCodes:      [Int] { [201, 202] }
    ...
    public var errorDescription: String? {
        ...
        case .resourceAlreadyExists:
            return NSLocalizedString("Resource already exists.",
                                     comment: "Error.resourceAlreadyExists")
            // Ресурс уже существует
        case .wrongPathTo:
            return NSLocalizedString("Wrong new path for resource",
                                     comment: "Error.wrongPathTo")
            // Неправильное новое положение для ресурса
        }
    }
