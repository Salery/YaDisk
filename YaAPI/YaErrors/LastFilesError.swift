...
public enum LastFilesError: Int, Error {
...
extension LastFilesError: LocalizedErrorStructProtocol {
    public var errorToLogoff:      Int  { 401 }
    public var successCodes:      [Int] { [200] }
    public var errorsToShowCache: [Int] { [0, 400, 404, 423, 429, 503] }
